...
config :insider_trading_info, InsiderTradingInfo.Repo,
  username: System.get_env("DB_USER_NAME", "postgres"),
  password: System.get_env("DB_PASSWORD", "postgres"),
  hostname: System.get_env("DB_HOST_NAME", "localhost"),
  database: System.get_env("DB_NAME", "insider_trading_info_dev"),
  stacktrace: true,
...
config :insider_trading_info, dev_routes: true
