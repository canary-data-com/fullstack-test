defmodule InsiderTradingInfoWeb.FallbackController do
  @moduledoc """
  ...
  def call(conn, {:error, %Ecto.Changeset{} = changeset}) do
    ...
    |> put_view(json: InsiderTradingInfoWeb.ChangesetJSON)
  ...
  def call(conn, {:error, :not_found}) do
    ...
    |> put_view(html: InsiderTradingInfoWeb.ErrorHTML, json: InsiderTradingInfoWeb.ErrorJSON)
    |> render(:"404")
  end
